 ...
 */
const methodInfo_ToDoService_DeleteAll = new grpc.web.AbstractClientBase.MethodInfo(
  proto.v1.DeleteAllResponse,
  /** @param {!proto.v1.DeleteAllRequest} request */
  function(request) {
    return request.serializeBinary();
  },
  proto.v1.DeleteAllResponse.deserializeBinary
);


/**
 * @param {!proto.v1.DeleteAllRequest} request The
 *     request proto
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @param {function(?grpc.web.Error, ?proto.v1.DeleteAllResponse)}
 *     callback The callback function(error, response)
 * @return {!grpc.web.ClientReadableStream<!proto.v1.DeleteAllResponse>|undefined}
 *     The XHR Node Readable Stream
 */
proto.v1.ToDoServiceClient.prototype.deleteAll =
    function(request, metadata, callback) {
  return this.client_.rpcCall(this.hostname_ +
      '/v1.ToDoService/DeleteAll',
      request,
      metadata || {},
 ...
 * @param {?Object<string, string>} metadata User defined
 *     call metadata
 * @return {!Promise<!proto.v1.DeleteAllResponse>}
 *     A native promise that resolves to the response
 */
proto.v1.ToDoServicePromiseClient.prototype.deleteAll =
    function(request, metadata) {
  return this.client_.unaryCall(this.hostname_ +
      '/v1.ToDoService/DeleteAll',
      request,
